...
// +-------------------------------------------------+
// $Id: rent_account.tpl.php,v 1.25 2019/12/31 12:50:41 ngantier Exp $
...
<div class='form-contenu'>
	...
	<div class='row'>
		<div class= 'colonne3'>
			<div id='el_account_receipt_limit_date' class='row'>
				...
				<div class='row'>
					<input type='date' id='account_receipt_limit_date' name='account_receipt_limit_date' value='!!receipt_limit_date!!' required />
				</div>
			</div>
		</div>
		<div class= 'colonne3'>
			<div id='el_account_receipt_effective_date' class='row'>
				...
				<div class='row'>
					<input type='date' id='account_receipt_effective_date' name='account_receipt_effective_date' value='!!receipt_effective_date!!' />
				</div>
			</div>
		</div>
		<div class= 'colonne3'>
			<div id='el_account_return_date' class='row'>
				...
				<div class='row'>
					<input type='date' id='account_return_date' name='account_return_date' value='!!return_date!!' />
				</div>
			</div>
		</div>
	</div>
	...
	<div id='el_account_event_date' class='row'>
		...
		<div class='row'>
			<input type='date' data-form-name='account_event_date' id='account_event_date' name='account_event_date' value='!!event_date!!' />
		</div>
	</div>
