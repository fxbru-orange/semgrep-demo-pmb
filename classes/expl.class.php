...
// +-------------------------------------------------+
// $Id: expl.class.php,v 1.137.2.4 2024/03/19 13:49:09 qvarin Exp $
...
if ( ! defined( 'EXEMPLAIRE_CLASS' ) ) {
    ...
    class exemplaire {
        ...
        public static function majNoticesMotsGlobalIndex($expl_id=0, $id_notice=0, $id_bulletin=0) {
            ...
            //On lance directement l'indexation pour éviter d'encombrer la pile
            indexation_stack::init_indexation();
        }
