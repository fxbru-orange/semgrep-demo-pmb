...
// +-------------------------------------------------+
// $Id: mail_reader_loans_late_relance.class.php,v 1.11 2023/02/02 15:58:53 dbellamy Exp $
...
class mail_reader_loans_late_relance extends mail_reader_loans_late {
    ...
    public function send_mail() {
        ...
        $requete="select id_empr, empr_mail, empr_nom, empr_prenom, empr_cb from empr where id_empr=".$this->mail_to_id;
