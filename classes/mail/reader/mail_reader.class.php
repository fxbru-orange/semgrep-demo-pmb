...
// +-------------------------------------------------+
// $Id: mail_reader.class.php,v 1.9.4.1 2023/09/13 13:55:21 dgoron Exp $
...
abstract class mail_reader extends mail_root {
	...
	protected function get_empr_coords() {
		...
		$query = "select id_empr, empr_mail, empr_nom, empr_prenom, empr_cb, empr_login, empr_location,";
