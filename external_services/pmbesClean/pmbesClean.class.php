...
// +-------------------------------------------------+
// $Id: pmbesClean.class.php,v 1.44.4.8 2024/01/05 11:35:13 tsamson Exp $
	...
	public function indexGlobal() {
		if (SESSrights & ADMINISTRATION_AUTH) {
			...
			if(!static::$progression) {
				...
				pmb_mysql_query("TRUNCATE TABLE notices_mots_global_index");
				pmb_mysql_query("TRUNCATE TABLE notices_fields_global_index");
...
// 			$result .= "<h3>".htmlentities($msg["nettoyage_suppr_auteurs"], ENT_QUOTES, $charset)."</h3>";
	...
	public static function getMethodsindexAuthorities() {
		return array(
				...
				'indexPublishers',		//PUBLISHERS
				'indexCategories',		//CATEGORIES
				'indexCollections',		//COLLECTIONS
				'indexSubCollections',	//SUBCOLLECTIONS
				'indexSeries',			//SERIES
				'indexIndexint',		//DEWEY
				'indexTitresUniformes'	//TITRES_UNIFORMES
		);
	}
	
	public function indexAuthorities($filters = array()) {
	...
	public static function getProgresion() {
		return static::$progression;
	}
	
	public static function setProgresion($progression) {
