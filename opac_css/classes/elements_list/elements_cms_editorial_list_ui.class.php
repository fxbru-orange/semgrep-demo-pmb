...
// +-------------------------------------------------+
// $Id: elements_cms_editorial_list_ui.class.php,v 1.1.2.2 2023/04/27 09:40:14 qvarin Exp $
...
class elements_cms_editorial_list_ui extends elements_list_ui
{
    ...
    private function get_template_path($type) {
        ...
        switch (true) {
            case file_exists($include_path.'/templates/cms_editorial/'.$type_name.'/'.$template_directory.'/section_in_result_display_subst.tpl.html'):
                return $include_path.'/templates/cms_editorial/'.$type_name.'/'.$template_directory.'/section_in_result_display_subst.tpl.html';
            case file_exists($include_path.'/templates/cms_editorial/'.$type_name.'/'.$template_directory.'/section_in_result_display.tpl.html'):
                return $include_path.'/templates/cms_editorial/'.$type_name.'/'.$template_directory.'/section_in_result_display.tpl.html';
        }
