...
// +-------------------------------------------------+
// $Id: bannette.class.php,v 1.116.4.5 2024/03/13 11:13:57 dgoron Exp $
...
class bannette {
	...
	public const MAX_NB_NOTICES_DIFF = 100;
...
// 		$this->limite_nombre		= intval($limite_nombre);
	...
	protected function get_query_records() {
		...
		$limitation = '';
		if ($this->use_limit) {
		    if ($this->nb_notices_diff && $this->nb_notices_diff <= static::MAX_NB_NOTICES_DIFF) {
		        $limitation = " LIMIT $this->nb_notices_diff ";
		    } else {
		        $limitation = " LIMIT ".static::MAX_NB_NOTICES_DIFF." ";
		    }
		}
	...
	protected function get_formatted_text($text, $empr=null) {
		...
		if ((!$this->nb_notices_diff || $this->nb_notices_diff > static::MAX_NB_NOTICES_DIFF)) {
		    $nb_envoyees = ($this->nb_notices <= static::MAX_NB_NOTICES_DIFF ? $this->nb_notices : static::MAX_NB_NOTICES_DIFF);
