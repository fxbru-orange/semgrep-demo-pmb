...
// +-------------------------------------------------+
// $Id: nomenclature_musicstand.class.php,v 1.2.4.3 2023/12/20 08:11:55 gneveu Exp $
...
class nomenclature_musicstand
{
    ...
    /**
     * returns the total number for one effective
     *
     * @return integer
     * @access public
     */
    public function get_cal_effective()
    {
        $this->calc_effective();
        return $this->effective;
    }
